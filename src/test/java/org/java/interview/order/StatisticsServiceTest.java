...
public class StatisticsServiceTest {
    ...
    private StatisticsService statisticsService = new StatisticsServiceTestImpl();
    ...
    public List<Order> findAll() {
        ...
        orders.add(new Order(CUST4, LocalDate.parse("2019-05-01"), BigDecimal.valueOf(10)));
        orders.add(new Order(CUST4, LocalDate.parse("2019-05-11"), BigDecimal.valueOf(24)));
